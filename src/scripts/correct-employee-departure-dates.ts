...
/**
 * @fileoverview Script pour corriger les dates de départ incorrectes des employés.
 * Ce script identifie les employés avec des dates de départ manifestement erronées
 * (par exemple, "01/01/2017" ou une date passée pour un employé actif) et les recalcule
 * sur la base de leur date de naissance (âge de la retraite à 60 ans).
 */
