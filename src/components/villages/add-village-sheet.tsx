...
export function AddVillageSheet() {
    ...
    const liveScore = calculateDevelopmentScore({
        ...
        mainEthnicGroups: csvToArray(currentValues.mainEthnicGroups),
        languages: csvToArray(currentValues.languages),
        mainActivities: csvToArray(currentValues.mainActivities),
        mainCrops: csvToArray(currentValues.mainCrops),
