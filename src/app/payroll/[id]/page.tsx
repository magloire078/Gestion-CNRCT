    ...
    return (
        <>
            ...
            <div id="print-section" className="w-full max-w-4xl mx-auto bg-white text-black print:shadow-none print:border-none font-arial text-[8px] leading-tight">
                {/* Header */}
                 <header className="flex justify-between items-center pb-4 mt-4 border-b-2 border-gray-400 mb-2">
                    <div className="w-1/4 text-center flex flex-col justify-center items-center h-28">
                     ...
                     <div className="w-1/4 text-center flex flex-col justify-center items-center h-28">
                        <p className="font-bold text-[10px]">REPUBLIQUE DE CÔTE D'IVOIRE</p>
                ...
                <div className="mt-8"> {/* Increased margin-top here */}
                    ...
                    {/* Footer */}
                    <footer className="text-center pt-4 mt-6 border-t-2 border-gray-400 text-xs">
