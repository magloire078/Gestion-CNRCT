...
/**
 * A reusable component for rendering a single payslip.
 */
export function PayslipTemplate({ payslipDetails }: { payslipDetails: PayslipDetails }) {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-white p-4 text-black font-arial text-[10px] leading-tight print-page-break flex flex-col">
            ...
            <main>
                <div className="text-center my-2 p-1 bg-slate-200 text-slate-900 font-bold rounded-md text-sm">
                ...
                <div className="border border-gray-400 rounded-lg mt-2 text-[10px]">
                    <table className="w-full border-collapse no-zebra">
                        ...
                        <tbody>
                            {earnings.map(item => (
                                <tr key={item.label} className="text-slate-800">
                            ...
                            <tr className="font-bold bg-slate-100 text-slate-900 border-y-2 border-slate-700">
                            ...
                            <tr className="text-slate-800 font-bold border-t-2 border-slate-700">
                    ...
                    <div className="flex justify-between items-center font-bold bg-slate-200 text-slate-900 border-t-2 border-slate-700">
