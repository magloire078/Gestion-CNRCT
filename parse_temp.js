const obj = {
  ...
  "Gontougo": {
    ...
    "Transua": {
      "Assuéfry": ["Abokro", "Adandia", "Adiamara", "Adiopénan", "Amonkobénankro", "Assuamakro", "Assuéfry", "Batoutié Foumassa", "Bossomkuikro", "Bouakro", "Dadiassé", "Datékro", "Hiango", "Kassabi", "Kékreni", "Kotokoua", "Kotokuini", "Kouam-Dari", "Kouassi-Séranou", "Mantoukoua", "Merekou", "N'gam", "Siédja", "Yakassé-Akidom", "Yao Dongokro", "Yomankro", "Yomian"],
      "Kouassi-Nianguini": ["Arrosua", "Assuakro", "Assuati", "Baoulékoffikro", "Dadiassé-Abrikokro", "Essi-Kouakoukro", "Kouadio-Dongokro", "Kouadjo-Kissikro", "Kouassi-Nianguini", "Kroupikro", "N'zuassé", "Signamalé", "Yao-Nango"],
      "Transua": ["Ahorofikro", "Ahuitiesso", "Akossuam", "Assuétia-Banon", "Assuétia-Kessé", "Attokom", "Bénanon", "Bissassé", "Diédou", "Kangassua", "Kassan", "Koihinikro", "Kouakoutanokro", "Krakro", "Krébio-Akoinkro", "Kromokrom", "Mantimandja", "Marassué", "N'detiesso-Sokoura", "Niamienbekyr", "Noumassi", "Pambasso", "Poko", "Priti 1", "Priti-Ahingro", "Sikassua", "Souromani", "Taakrom", "Tanokouassikro", "Tounvokro", "Transua", "Yaokumkro"]
    }
  },
  "Grands-Ponts": {
    "Dabou": {
