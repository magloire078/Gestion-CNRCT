...
export function PrintSingleLabel({ asset, settings }: PrintSingleLabelProps) {
  return (
    <div id="print-section" className="font-arial">
      <div 
        className="flex flex-col items-center justify-center text-center overflow-hidden break-words"
        style={{
