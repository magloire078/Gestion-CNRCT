...
export function EmptyState({ icon: Icon, message }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-8 text-center bg-card/40 backdrop-blur-md rounded-xl border border-white/10 shadow-xl overflow-hidden group">
