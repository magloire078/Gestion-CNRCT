...
export default function EvaluationDetailPage() {
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            await updateEvaluation(id, evaluation);
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="text-muted-foreground">La notation des compétences sera bientôt disponible ici.</div>
                </CardContent>
            </Card>
             ...
             <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <Textarea id="strengths" name="strengths" value={evaluation.strengths} onChange={handleInputChange} rows={5} />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="areasForImprovement">Axes d'Amélioration</Label>
                        <Textarea id="areasForImprovement" name="areasForImprovement" value={evaluation.areasForImprovement} onChange={handleInputChange} rows={5} />
                    </div>
                     <div className="space-y-2 md:col-span-2">
                        <Label htmlFor="managerComments">Commentaires du Manager</Label>
                        <Textarea id="managerComments" name="managerComments" value={evaluation.managerComments} onChange={handleInputChange} rows={5} />
                    </div>
                </CardContent>
            </Card>
        </div>
